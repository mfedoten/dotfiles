...
alias update='sudo port selfupdate; sudo port -v upgrade outdated; sudo port clean --all installed; sudo port uninstall --follow-dependencies inactive; sudo updatedb'
